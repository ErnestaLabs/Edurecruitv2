...
export default function ContactPage() {
    const [state, setState] = useState<LeadFormState>({ success: false, message: "" })
          ...
          <div className="container-wide px-4 md:px-8">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-text-muted">
                Book a free 30-minute consultation to discuss your goals. No obligation,
                just honest advice about how we can help.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-12 md:grid-cols-5">
              ...
              <div className="md:col-span-3">
                <Card className="border-warm-grey-200 bg-white p-8 md:p-12">
                  <h2 className="font-heading text-2xl text-navy">Book your free consultation</h2>
                  <p className="mt-2 text-sm text-text-muted">
                    Fill in the form below and we&apos;ll be in touch within 24 hours.
                  </p>
                  <form onSubmit={(e) => { e.preventDefault(); formAction(new FormData(e.currentTarget)) }} className="mt-8 space-y-6">
                    <div>
                    ...
                    >
                      {pending ? "Sending..." : "Send enquiry"} <Send className="ml-2 size-4" />
                    </Button>
                    <p className="text-xs text-text-muted text-center">
                      By submitting this form, you agree to our{" "}
                      <a href="/legal/privacy" className="underline hover:text-navy">Privacy Policy</a>.
              ...
              <div className="md:col-span-2">
                <div className="space-y-8">
                  <div>
                    <h3 className="font-heading text-xl text-navy">Get in touch</h3>
                    <p className="mt-2 text-sm text-text-muted">
                  ...
                  <div className="rounded-xl border border-warm-grey-200 bg-cream p-6">
                    <h4 className="font-heading text-lg text-navy">What to expect</h4>
                    <ul className="mt-4 space-y-3 text-sm text-text-muted">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-0.5 text-gold">→</span>
                        We&apos;ll ask about your goals and assess how we can help
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-0.5 text-gold">→</span>
