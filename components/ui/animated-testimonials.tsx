        ...
        <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between py-4">
            ...
            <div className="flex gap-4 pt-12 md:pt-0">
              ...
              <button className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-gold/20">
                <IconArrowRight className="h-5 w-5 text-gold" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            ...
            >
              <IconArrowLeft className="h-5 w-5 text-gold transition-transform duration-300 group-hover/button:rotate-12" />
            </button>
            <button
              onClick={handleNext}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-gold/20 hover:bg-gold/30"
            >
              <IconArrowRight className="h-5 w-5 text-gold transition-transform duration-300 group-hover/button:-rotate-12" />
            </button>
          </div>
        </div>
      </div>
